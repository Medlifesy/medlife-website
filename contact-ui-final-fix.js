...
/* Hide only the legacy Contact markup during rebuild to prevent a visible flash. */
body.contact-upgrade-pending>header.hero,
body.contact-upgrade-pending>main.wrap,
body.contact-upgrade-pending>#medlife-contact-v8{visibility:hidden!important;opacity:0!important}
...
/* Action group: four equal controls, aligned and centered. */
...
setTimeout(init,50);setTimeout(init,300);setTimeout(init,800);setTimeout(reveal,3500);
})();