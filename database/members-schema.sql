...
CREATE TABLE IF NOT EXISTS members (
    ...
    cell TEXT NOT NULL CHECK (cell IN ('plasma_cell','neuron_cell','astrocyte_cell','leukocyte_cell','heart_cell','red_blood_cell','blog','design','video_editing','visual_media','instagram','telegram','administration','voice_over','coordination','university_media','field')),
    field_location TEXT,
    ...
    CHECK ((cell = 'field' AND field_location IS NOT NULL) OR (cell != 'field'))
);
