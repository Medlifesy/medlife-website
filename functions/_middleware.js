export async function onRequest(context) {
  ...
  // Make the top navigation point to the real homepage gallery anchor.
  html = html.replace(/href=["']#activities["']/gi, 'href="#homepageGallery"');
  if (!html.includes('href="#homepageGallery"')) {
    html = html.replace(/(<a[^>]+href=["']articles\.html["'][^>]*>)/i, '<a href="#homepageGallery">صورنا</a>\n$1');
  }
