export async function onRequest(context) {
  ...
  try {
    ...
    const marker = '<script src="/article-management-v3.js?v=20260825-10" defer></script><script src="/article-management-enhancements.js?v=20260825-2" defer></script><script src="/article-format-fast-ui.js?v=20260825-1" defer></script>';
