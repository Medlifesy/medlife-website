/* MEDLIFE AUTH HELPERS
   ...
   New hashes use the same 120,000-iteration PBKDF2-SHA256
   configuration as member-auth-v3. Verification remains backward
   compatible because it reads the iteration count stored in the hash.
*/
...
export async function hashToken(token){
  return bytesToHex(await crypto.subtle.digest('SHA-256',enc.encode(token)));
}
