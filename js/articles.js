...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Keep only legacy cards that have not yet been replaced by D1 articles.
    ...
    async function loadArticles(){
        ...
        try{
            ...
            remoteArticles.forEach(a=>{remoteKeys.add(String(a.id));remoteKeys.add(String(a.slug||""));remoteKeys.add(String(a.legacy_url||"").split("/").pop().replace(/\.html$/,""));});
