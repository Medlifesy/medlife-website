...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function renderGallery() {
        ...
        galleryImages.forEach(image => {
            photoTrack.appendChild(createPhotoCard(image));
        });

        galleryImages.forEach(image => {
            photoTrack.appendChild(createPhotoCard(image, true));
        });
    }
    ...
    function showLoading() {
        photoTrack.innerHTML = `
            <div class="gallery-loading">
                ...
                <span>جاري تحميل صور ميدلايف...</span>
            </div>
        `;
    }
    ...
    function addFeaturedArticle() {
        ...
        const existing = document.getElementById("tension-headache-home-article");
        ...
        card.innerHTML = `
            ...
            <div class="article-body">
                <div class="article-category">توعية صحية</div>

                <h3>صداع التوتر: رحلتك نحو الراحة</h3>

                <p>
                    تعرف على صداع التوتر، أسبابه وأعراضه،
                    علامات الخطر، العلاج المتكامل وطرق الوقاية.
                </p>
