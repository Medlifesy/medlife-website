  ...
  function build() {
    ...
    if (!document.getElementById('medlife-global-nav-style')) {
      ...
      style.textContent = `
        ...
        .medlife-global-nav a i{font-size:11px;opacity:.72;transition:transform .2s ease,opacity .2s ease}.medlife-global-nav a::after{content:"";position:absolute;left:9px;right:9px;bottom:9px;height:3px;border-radius:999px;background:#ff2a54;transform:scaleX(0);transition:transform .22s ease}.medlife-global-nav a:hover{color:#ff2a54;background:#fff7f9;border-radius:10px}.medlife-global-nav a:hover i{opacity:1;transform:translateY(-1px)}.medlife-global-nav a.active{color:#ff2a54}.medlife-global-nav a.active i{opacity:1}.medlife-global-nav a.active::after{transform:scaleX(1)}
        .medlife-global-actions{display:flex;flex:0 0 auto;align-items:center;gap:7px}.medlife-global-actions a{display:inline-flex;align-items:center;gap:6px;border:1px solid #dde4ed;border-radius:11px;padding:8px 10px;color:#151d36;background:#fff;text-decoration:none;font:800 10.5px Cairo,sans-serif;white-space:nowrap;transition:.2s ease}.medlife-global-actions a:hover{transform:translateY(-1px);border-color:#ff2a54;color:#ff2a54;box-shadow:0 8px 18px rgba(21,29,54,.07)}.medlife-global-actions .join{background:#ff2a54;border-color:#ff2a54;color:#fff;box-shadow:0 7px 16px rgba(255,42,84,.18)}.medlife-global-actions .join:hover{color:#fff;background:#ea234a;border-color:#ea234a}
        .medlife-global-menu{display:none;align-items:center;gap:7px;border:1px solid #dde4ed;background:#f7f9fc;color:#151d36;border-radius:11px;padding:9px 12px;font:800 12px Cairo,sans-serif;cursor:pointer}.medlife-global-mobile{border-top:1px solid #e8edf3;background:#fff;box-shadow:0 10px 20px rgba(21,29,54,.06)}.medlife-global-mobile a{display:flex;align-items:center;gap:10px;padding:12px 18px;border-bottom:1px solid #eef2f7;color:#151d36;text-decoration:none;font:800 13px Cairo,sans-serif}.medlife-global-mobile a i{width:18px;text-align:center;opacity:.7}.medlife-global-mobile a.active{color:#ff2a54;background:#fff7f9;border-inline-start:3px solid #ff2a54}.medlife-global-mobile .mobile-join{color:#fff;background:#ff2a54;border-inline-start:0;justify-content:center;margin:10px 14px;border-radius:12px;border-bottom:0}
